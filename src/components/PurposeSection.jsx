...
const PurposeSection = () => {
  return (
    <section
      className="w-full  py-20 px-4 sm:px-6 md:px-8 relative  overflow-x-hidden"
      id="about"
    >
      <div className="mx-auto max-w-6xl absolute bottom-28 right-28 w-[200px] h-[200px] bg-gradient-to-tr  from-red-500/20 to-pink-500/20 rounded-full blur-[80px] -z-10" />
